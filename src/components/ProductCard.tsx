    ...
    >
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="flex gap-2 pt-2">
          <Button size="sm" variant="outline" className="flex-1 text-xs" onClick={() => addToCart(product)}>
            <ShoppingCart className="w-3 h-3 mr-1" /> Aggiungi
          </Button>
          <a href={`https://wa.me/393207690096?text=${waMsg}`} target="_blank" rel="noopener noreferrer">
